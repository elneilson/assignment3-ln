...
**Figure 1.** Cetacean species richness. Species richness was calculated using a probability threshold of >= 0.6, indicating values at which a species is considered to be present. Raster stack was converted into a data frame and plotted over an outline of California's coast (data provided from the `rnaturalearth` package). Cetacean species richness seems to be highest in California's southern coast.
